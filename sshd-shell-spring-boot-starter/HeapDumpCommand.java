...
//@SshdShellCommand(value = "heapDump", description = "Heap dump report")
//public class HeapDumpCommand {
//    
//    @Autowired
//    private HeapDumpWebEndpoint heapDumpWebEndpoint;
//    
//    public String heapDump(String arg) {
//        return ConsoleIO.asJson(heapDumpWebEndpoint.heapDump(Boolean.TRUE));
//    }
//}
